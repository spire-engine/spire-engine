...
namespace GameEngine
{
    ...
    private:
        ...
        GraphicsUI::StatusStrip* statusStrip;
        GraphicsUI::StatusPanel* statusPanel;
        GraphicsUI::StatusPanel* progressPanel;
        ...
        void BakeLightmaps()
        {
            statusPanel->SetText("Baking lightmaps...");
            if (lightmapBaker)
            ...
            else
            {
                ...
                {
                    progressPanel->SetProgress(e.ProgressValue, e.ProgressMax);
                });
        ...
        void InitUI()
        {
            ...
            auto mnDebug = new MenuItem(mainMenu, "&Debug");
            for (auto debugView : Engine::Instance()->GetRenderer()->GetDebugViews())
            {
                auto mnDebugView = new MenuItem(mnDebug, debugView);
                mnDebugView->OnClick.Bind(this, &LevelEditorImpl::mnDebugView_Clicked);
            }
            ...
            statusStrip = new StatusStrip(entry);
            statusStrip->DockStyle = Control::dsBottom;
            statusStrip->Padding = EM(0.25f);
            statusStrip->SetHeight(EM(1.5f));
            statusPanel = new StatusPanel(statusStrip, "Ready.", 0, StatusPanel::Fill);
            progressPanel = new StatusPanel(statusStrip, StatusPanel::Progress, EM(12.0f), StatusPanel::Fixed);
    ...
    public:
        ...
        void mnDebugView_Clicked(UI_Base* sender)
        {
            Engine::Instance()->GetRenderer()->SetDebugView(((GraphicsUI::MenuItem*)sender)->GetText());
        }
